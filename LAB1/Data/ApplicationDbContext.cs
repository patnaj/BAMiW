...
namespace LAB1.Data
{
    ...
    public class ApplicationDbContext : IdentityDbContext<UserModel, RoleModel, int>
    {
        ...
        //         .HasData(
        //             new UserModel(){Id = 1, UserName="Adam Nowak", NormalizedUserName="Adam Nowak", Email="adam@example.com", NormalizedEmail="adam@example.com", EmailConfirmed=true, SecurityStamp = string.Empty}
        //                 .setPass("test1"),
        //             new UserModel(){Id = 2, UserName="Jan Nowak", NormalizedUserName="Jan Nowak", Email="jan@example.com", NormalizedEmail="jan@example.com", EmailConfirmed=true, SecurityStamp = string.Empty}
        //                 .setPass("test2")
        //         );
        ...
        //     builder.Entity<InvoiceItemModel>()
        //         .HasData(
