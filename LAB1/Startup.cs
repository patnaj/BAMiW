...
namespace LAB1
{
    public class Startup
    {
        ...
        async void UserSeed(IServiceCollection services, bool restoreUsers = true)
        {
            ...
            var user = new UserModel() { Id = 1, UserName = "Adam Nowak", NormalizedUserName = "Adam Nowak", Email = "adam@example.com", NormalizedEmail = "adam@example.com", EmailConfirmed = true, SecurityStamp = string.Empty };
            await userManager.CreateAsync(user, "testtest@1");
            await userManager.AddToRoleAsync(user, "User");
            await userManager.AddToRoleAsync(user, "Admin");
            user = new UserModel() { Id = 2, UserName = "Jan Nowak", NormalizedUserName = "Jan Nowak", Email = "jan@example.com", NormalizedEmail = "jan@example.com", EmailConfirmed = true, SecurityStamp = string.Empty };
            await userManager.CreateAsync(user, "testtest@1");
            await userManager.AddToRoleAsync(user, "User");
